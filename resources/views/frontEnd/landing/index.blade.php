...
<head>
 ...
 <title> Cpmedu school management software & School management system </title>
<meta name="description" content="Cpmedu is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
...
[ {
  ...
  "name" : "CPMEDU - Best School Management software system",
  "url" : "http://cpmedu.com/",
  "author" : {
    "@type" : "Company",
    "name" : "Spondon IT"
  ...
  "downloadUrl" : "http://cpmedu.com",
  "operatingSystem" : "2019",
  "requirements" : "in a complete",
  "screenshot" : "http://cpmedu.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@CPMEdu"/>
        <meta name="twitter:creator" content="@CPMEdu"/>
        <meta name="twitter:url" content="//cpm.com/"/>
        <meta name="twitter:title" The Ultimate Education Management System For School,  Institute & Academy"/>
        <meta name="twitter:description" content="Cpmedu is a well known School management system and its ERP based Software. So try the free demo today!. Cause Cpmedu offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:image" content="http://cpmedu.com/public/landing/img/dashboard_preview.png"/>


        <!-- Open Graph data -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="//cpmedu.com/"/>
        <meta property="og:image" content="//cpmedu.com/public/landing/img/dashboard_preview.png"/>
        <meta property="og:title" content="School Management ERP Software & School Management System - Cpmedu"/>

        <meta property="og:description" content="Cpmedu is a well known School management system and its ERP based Software. So try the free demo today!. Cause Cpmedu offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:site_name" content="Cpmedu" />

    <link rel="canonical" href="http://cpmedu.com" hreflang="en-us" />
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Managing various administrative tasks in one place is now quite easy and time
                                savior with this CPMEDU and Give your valued time to your institute that will
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.cpmedu.com/">Purchase</a> -->
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>CPMEDU has all in one place. You’ll find everything what you are looking into education
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>You know! Smart Idea always comes to well planners. And Our CPMEDU is Smart for its Well
                                Documentation.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="video_section_text">
                        <h2>Take A look Our CPMEDU Overview in Video</h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-8">
                    <div class="section_tittle text-center">
                        <h5>AMazing Features</h5>
                        <h2>More Features Has CPMEDU</h2>
                        <p>it's vast! Cpmedu has more additional feature that will expect in a complete solution.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
    ...
    <section class="contact_us padding_top" id="Support">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <a class="support-link" target="_blank" href="https://ticket.aorasoft.com/cpmedu">
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><i class="ti-write"></i></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <p>We Believe! It won’t a wrong decision in Purchasing our CPMEDU for your Institute.</p>
                        <!-- <a href="http://salespanel.cpmedu.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text"> 
                        <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 CPMEdu - Ultimate Education ERP. All Rights
