...
<head>
    ...
    <title>{{ $setting->site_title ? $setting->site_title :  'Cpmedu Edu ERP' }}</title>
    ...
    <link rel="stylesheet" href="{{asset('public/')}}/frontend/css/cpm.css"/>
    <x-root-css/>
            ...
            <div class="container box-1420">
                ...
                <a class="navbar-brand" href="{{url('/')}}/home">
                    <img class="w-75"
                         ...
                         alt="Cpmedu Logo" style="max-width: 150px;">
                </a>
