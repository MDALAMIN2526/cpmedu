...
<head>
    ...
    <link rel="alternate" href="http://cpmedu.com" hreflang="en-us" />
    ...
    <link rel="stylesheet" href="{{asset('public/backEnd/')}}/css/cpm.css"/>
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to Cpmedu </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing Cpmedu for your school administration. Please follow the steps to complete Cpmedu Edu installation!</p>
