...
http://localhost/cpmedu/lms-design -->
                    ...
                    <div class="eduLms_video_area">
                        ...
                        <div class="video_palyer_area position-relative d-flex ">
                            ...
                            <div class="video_palyer_list_wrapper">
                                <div class="cpmLms_video_palyer_lists d-flex flex-column postion-relative">
                                    ...
                                    <!-- accordian -->
                                    <div class="accordion cpmLms_accordian  mb_50 flex-fill" id="accordion_ex">
                                        @include('lms.chapter')
