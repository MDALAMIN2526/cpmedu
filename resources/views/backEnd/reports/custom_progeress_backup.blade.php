...
<div class="container"> 
        <table style="width:100%; border:0;"> 
                <tr >
                    ...
                    <th colspan="2"> 
                        <h3 class="text-white"> {{isset(generalSetting()->school_name)?generalSetting()->school_name:'Cpmedu School Management ERP'}} </h3> 
                        <p class="text-white mb-0" style="padding-right:10px !important;"> {{isset(generalSetting()->address)?generalSetting()->address:'Cpmedu School Address'}} </p>
                    </th> 
