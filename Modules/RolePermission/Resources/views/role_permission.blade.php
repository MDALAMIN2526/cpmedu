                                        ...
                                        <li>
                                            <div class="submodule">
                                                <input id="Sub_Module_{{ $row2->id }}" name="module_id[]"
                                                    value="{{ $row2->id }}"
                                                    class="cpm_csk common-radio  module_id_{{ $permission->id }} module_link"
                                                    type="checkbox"
                                                    ...
                                                    <li>
                                                        <div class="module_link_option_div" id="{{ $row2->id }}">
                                                            <input id="Option_{{ $row3->id }}" name="module_id[]"
                                                                value="{{ $row3->id }}"
                                                                class="cpm_csk common-radio    module_id_{{ $permission->id }} module_option_{{ $permission->id }}_{{ $row2->id }} module_link_option"
                                                                type="checkbox"
