...
class CreateCpmModuleStudentParentInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cpm_module_student_parent_infos', function (Blueprint $table) {
            $table->increments('id');
        ...
        // DB::table('cpm_module_student_parent_infos')->truncate();
      ...
      //  -- Wallet
       ...
       foreach($datas as $data){
            $new = new CpmModuleStudentParentInfo();
            $new->id = $data[0];
    ...
    {
        Schema::dropIfExists('cpm_module_student_parent_infos');
    }
}
