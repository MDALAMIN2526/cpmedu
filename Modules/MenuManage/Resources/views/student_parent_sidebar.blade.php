   ...
   <div  class="mesonary_role_header"  id="sortable" >
      ...
      @if(Auth::user()->role_id==2 || Auth::user()->role_id==3) 
        ...
        @if(!$student_parent_module->admin_section || isMenuAllowToShow($student_parent_module->admin_section))
           ...
           @if($check_sidebar !='')
           @if(in_array($student_parent_module->cpm_module_id,$permission_ids))
                 <?php 
                ...
                <div class="single_role_blocks" data-id="menu_org{{ $student_parent_module->module_id }}">
                     <div class="single_permission" id="{{$student_parent_module->cpm_module_id}}">
                        <div class="permission_header d-flex align-items-center justify-content-between">
                           <div>
                              <input type="checkbox" name="module_id[]" value="{{$student_parent_module->cpm_module_id}}" 
                              id="Main_Module_{{$key}}" class="common-radio permission-checkAll main_module_id_{{$student_parent_module->cpm_module_id}}" {{ $check_sidebar !='' ? (in_array($student_parent_module->cpm_module_id,$already_assigned)? 'checked':''):'checked'}}
                           
                              >
                              <input type="hidden" value="{{$student_parent_module->cpm_module_id}}" name="all_modules_id[]">
                        ...
                        <div id="Role{{$student_parent_module->module_id}}" class="collapse">
                           <div  class="permission_body">
                              <ul class="submenuSort">                              
                                 ...
                                 <li>
                                    <div class="submodule"> 
                                      <input type="hidden" value="{{$row2->cpm_module_id}}" name="all_modules_id[]">
                                       <input id="Sub_Module_{{$row2->cpm_module_id}}" name="module_id[]" value="{{$row2->cpm_module_id}}" 
                                       class="cpm_csk common-radio  module_id_{{$student_parent_module->cpm_module_id}} module_link"  type="checkbox" 
                                       {{ $check_sidebar !='' ?(in_array($row2->cpm_module_id,$already_assigned)? 'checked':''): 'checked'}}
                                       >
                                 ...
                                 <li>
                                    <div class="submodule"> 
                                      <input type="hidden" value="{{$row2->id}}" name="all_modules_id[]">
                                       ...
                                       class="cpm_csk common-radio  module_id_{{$student_parent_module->id}} module_link"  type="checkbox" 
