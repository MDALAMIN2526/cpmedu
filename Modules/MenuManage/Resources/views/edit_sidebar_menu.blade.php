                                                                       ...
                                                                       <div  class="permission_body">
                                                                               <ul>
                                                                                   ...
                                                                                   <?php 
                                                                                       ...
                                                                                       $subModule= DB::table('sidebars')->where('parent_id',$module_info->cpm_module_id)->where('active_status', 1)->get();
                                                                                   ?>
                                                 ...
                                                 @foreach($all_modules as $key => $row)
                                                          @php
                                                             ...
                                                             if (moduleStatusCheck('SaasRolePermission') == TRUE) {
                                                                 $module_info = Modules\RolePermission\Entities\CpmModuleInfo::where('module_id', $key)->first();
                                                                 $all_group_modules = Modules\RolePermission\Entities\CpmModuleInfo::where('module_id', $key)->where('id', '!=', $key)->get();
                                                             } else {
                                                                 $module_info = Modules\RolePermission\Entities\CpmModuleInfo::where('module_id', $key)->where('is_saas',0)->first();
                                                                 $all_group_modules = Modules\RolePermission\Entities\CpmModuleInfo::where('module_id', $key)->where('id', '!=', $key)->where('is_saas',0)->get();
                                                             }
                                                                                             ...
                                                                                             ?>
                                                                                                 ...
                                                                                                 <li>
                                                                                                     <div class="submodule">
                                                                                                         ...
                                                                                                         <input id="Sub_Module_{{$row2->id}}" name="child_module_id[]" value="{{$row2->id}}"  class="cpm_csk common-radio  module_id_{{$module_info->id}} module_link" checked  type="checkbox">
