...
class GlobalVariable{
	...
	public static function GlobarModuleLinks(){
        try {
            ...
            $permissions = CpmPermissionAssign::where('role_id', Auth::user()->role_id)->where('school_id', Auth::user()->school_id)->get();
    ...
    public static function SaasRoleModule(){
        try {
            ...
            $permissions = CpmPermissionAssign::where('role_id', Auth::user()->role_id)->get();
