...
Route::group(['middleware' => ['XSS','auth:api','json.response']], function () {
    ...
    // https://cpmedu.com/api/search-student?class=2
    // https://cpmedu.com/api/search-student?section=1&class=2
    // https://cpmedu.com/api/search-student?name=Conner Stamm
    // https://cpmedu.com/api/search-student?roll_no=28229
   ...
   Route::get('pending-leave/{user_id}', 'api\ApiSmLeaveController@pendingLeave');
    ...
    //cpmedu.com/android/api/group-token?id=2&body=Notification body&title=Notification title
