...
class CreateSmStylesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('sm_styles', function (Blueprint $table) {
            ...
            $table->string('path_cpm_style', 255)->nullable();
        ...
        // $s->path_cpm_style = 'blue_version/cpm.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_cpm_style = 'orange_version/cpm.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_cpm_style = 'paste_version/cpm.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_cpm_style = 'darkblue_version/cpm.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_cpm_style = 'pink_version/cpm.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_cpm_style = 'dark_version/cpm.css';
        // $s->primary_color = '#000';
