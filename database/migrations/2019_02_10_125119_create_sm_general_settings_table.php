...
class CreateSmGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_general_settings', function (Blueprint $table) {
            ...
            $table->string('system_version')->nullable()->default('7.1.1');
            ...
            $table->integer('CpmBiometrics')->default(0)->nullable();
        ...
        DB::table('sm_general_settings')->insert([
            [
                ...
                'currency' => 'USD',
                'currency_symbol' => '$',
                'school_name' => 'Cpmedu Edu',
                'site_title' => 'Cpmedu Education software',
                'session_id' => 1,
                'week_start_id' => 3,
                'time_zone_id' => 51,
