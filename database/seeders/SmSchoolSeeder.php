...
class SmSchoolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>2,
        //                             'email'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@cpmedu.com', 
        //                             'username'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@cpmedu.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>3,
        //                             'email'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@cpmedu.com', 
        //                             'username'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@cpmedu.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        ...
        //                 }
        //             }
        //             $rules = CpmRole::where('active_status', '=', '1')->where('id', '!=', 1) /* ->where('id', '!=', 2) */->where('id', '!=', 3)->where('id', '!=', 10)->get();
        ...
        //         for ($j = 1; $j <= 541; $j++) {
        //             $permission = new CpmPermissionAssign();
        ...
        //         foreach ($ids as $id) {
        //             $permission = CpmPermissionAssign::where('school_id', $school->id)->where('role_id', 5)->where('module_id', $id)->first();
        //             if ($permission) {
        //                 $permission->delete();
        //             }
        //         }
        ...
        //                 $theme->path_cpm_style = 'lawngreen_version/cpm.css';
        //                 $theme->path_cpm_style = false;                   
        //                 $theme->box_shadow = true;                   
        //             }else {
        //                 $theme->path_main_style = 'style.css';
        //                 $theme->path_cpm_style = 'cpm.css';
        ...
        //         $s->link_label1 = 'About Cpmedu';
        //         $s->link_href1  = 'http://cpmedu.com';
        
        //         $s->link_label2 = 'Cpmedu Home';
        //         $s->link_href2  = 'http://cpmedu.com/home';
        
        //         $s->link_label3 = 'Business';
        //         $s->link_href3  = 'http://cpmedu.com';
        
        //         $s->link_label4 = 'link_label4';
        //         $s->link_href4  = 'http://cpmedu.com';
        
        //         $s->link_label5 = 'link_label5';
        //         $s->link_href5  = 'http://cpmedu.com';
        
        //         $s->link_label6 = 'link_label6';
        //         $s->link_href6  = 'http://cpmedu.com';
        
        //         $s->link_label7 = 'link_label7';
        //         $s->link_href7  = 'http://cpmedu.com';
        
        //         $s->link_label8 = 'link_label8';
        //         $s->link_href8  = 'http://cpmedu.com';
        
        //         $s->link_label9  = 'Home';
        //         $s->link_href9   = 'http://cpmedu.com/home';
        
        //         $s->link_label10 = 'About';
        //         $s->link_href10  = 'http://cpmedu.com/about';
        
        
        //         $s->link_label11 = 'Contact';
        //         $s->link_href11  = 'http://cpmedu.com/contact';
        
        //         $s->link_label12 = 'link_label12';
        //         $s->link_href12  = 'http://cpmedu.com';
        
        //         $s->link_label13 = 'link_label13';
        //         $s->link_href13  = 'http://cpmedu.com';
        
        //         $s->link_label14 = 'link_label14';
        //         $s->link_href14  = 'http://cpmedu.com';
        
        //         $s->link_label15 = 'link_label15';
        //         $s->link_href15  = 'http://cpmedu.com';
        
        //         $s->link_label16 = 'link_label16';
        //         $s->link_href16  = 'http://cpmedu.com';
        //         $s->school_id = $school->id; 
        //         $s->save();
